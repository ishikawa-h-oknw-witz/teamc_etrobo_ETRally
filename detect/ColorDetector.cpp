...
{
    { Color::Red,      0,29, 36,100,11,100 },
    { Color::Red,    280,360,36,100,11,100 },
    { Color::Blue,   160,279,36,100,11,100 },
    { Color::Yellow,  30, 69,36,100,11,100 },
    { Color::Green,   70,159,36,100,11,100 },
    { Color::Gray,     0,360, 0, 35,11, 89 },
    { Color::Black,    0,360, 0,100, 0, 10 },
    { Color::White,    0,360, 0, 35,90,100 }
};
