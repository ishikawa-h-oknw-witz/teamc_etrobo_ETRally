...
// 無彩色
// --------------------------------------------------------
    { Color::Black, 210, 32, 7, 1.0, 1.0, 1.0 },
    { Color::White, 0, 4, 99, 1.0, 1.0, 1.0 },
    { Color::Gray, 205, 23, 56, 1.0, 1.0, 1.0 },

// ------------------------------N6--------------------------
// 有彩色
// --------------------------------------------------------
    { Color::Green, 150, 82, 59, 2.0, 2.0, 1.5 },
    { Color::Yellow, 52, 67, 99, 1.0, 1.0, 1.0 },

// Red / BlueはH・S・Vを比較的バランスよく評価する。
    { Color::Red, 353, 96, 96, 1.0, 1.0, 1.0 },
    { Color::Blue, 213, 98, 66, 1.25, 1.25, 1.0 }
};
