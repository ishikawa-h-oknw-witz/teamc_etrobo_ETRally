...
// 無彩色
// --------------------------------------------------------
    { Color::Black, 220, 37, 9, 1.0, 1.0, 1.0 },
    { Color::White, 177, 15, 99, 1.0, 1.0, 1.0 },
    { Color::Gray, 208, 28, 89, 1.0, 1.0, 1.0 },

// ------------------------------N6--------------------------
// 有彩色
// --------------------------------------------------------
    { Color::Green, 150, 80, 62, 2.0, 2.0, 1.5 },
    { Color::Yellow, 50, 64, 99, 1.0, 1.0, 1.0 },

// Red / BlueはH・S・Vを比較的バランスよく評価する。
    { Color::Red, 351, 94, 93, 1.0, 1.0, 1.0 },
    { Color::Blue, 212, 96, 62, 1.25, 1.25, 1.0 }
};
