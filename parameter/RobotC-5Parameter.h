...
{
    { 0,  {80.0f, 100.0f, 100.0f, 500.0f}, 500, 100, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.3f, 0.0f, 0.4f}}, // Lap直線1
    { 1,  {90.0f, 90.0f,  80.0f, 150.0f}, 150,  80, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.8f, 0.0f, 0.5f}}, // Lapカーブ1-1
    { 2,  {80.0f, 80.0f, 80.0f,  100.0f}, 100,  70, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.7f, 0.0f, 0.5f}}, // Lapカーブ1-2
    { 3,  {80.0f, 90.0f, 90.0f,  150.0f}, 150,  80, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.8f, 0.0f, 0.5f}}, // Lapカーブ1-3
    { 4,  {90.0f, 100.0f, 90.0f,  400.0f}, 400, 100, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.3f, 0.0f, 0.4f}}, // Lap直線2
    { 5,  {90.0f, 90.0f, 80.0f, 150.0f}, 150,  80, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {1.0f, 0.0f, 0.5f}}, // Lapカーブ2-1
    { 6,  {80.0f, 80.0f, 80.0f,  100.0f}, 100,  70, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.9f, 0.0f, 0.5f}}, // Lapカーブ2-2
    { 7,  {80.0f, 90.0f, 90.0f,  100.0f}, 100,  80, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {1.0f, 0.0f, 0.5f}}, // Lapカーブ2-3
    { 8,  {90.0f, 100.0f, 70.0f,  300.0f}, 300, 100, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.3f, 0.0f, 0.4f}}, // Lap直線3
    { 9,  {70.0f, 70.0f, 70.0f,  400.0f}, 400,  60, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.9f, 0.0f, 0.6f}}, // Lapカーブ3
    {10,  {70.0f, 100.0f, 90.0f,  900.0f}, 900, 100, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.7f, 0.0f, 0.4f}}, // Lap蛇行1
    {11,  {90.0f, 100.0f, 90.0f,  950.0f}, 950,  80, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.9f, 0.0f, 0.4f}}, // Lap蛇行2
    {12,  {90.0f, 100.0f, 70.0f,  850.0f}, 850, 100, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.7f, 0.0f, 0.4f}}, // Lap直線4
    ...
    {20,  {30.0f, 100.0f, 50.0f,  550.0f}, 550,  70, RunnerEdge::LeftEdge,  {Color::None}, CalibrationData::BlackWhiteCenter, {0.5f, 0.0f, 0.4f}}, // 青ボトル位置まで
    {21,  {30.0f, 100.0f, 50.0f,  850.0f}, 850,  70, RunnerEdge::LeftEdge,  {Color::None}, CalibrationData::BlackWhiteCenter, {0.5f, 0.0f, 0.4f}}, // 赤ボトル位置まで

    {22,  {30.0f, 80.0f,  50.0f,  370.0f}, 370,  60, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.4f, 0.0f, 0.6f}}, // Dlv帰還直線 黄
    {23,  {30.0f, 80.0f, 50.0f,  620.0f}, 620,  60, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.4f, 0.0f, 0.6f}}, // Dlv帰還直線 青
    {24,  {30.0f, 100.0f, 50.0f,  920.0f}, 920,  60, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.4f, 0.0f, 0.6f}}, // Dlv帰還直線 赤
    ...
    {28,  {40.0f, 40.0f,  40.0f,   0.0f}, 0,  40, RunnerEdge::RightEdge, {Color::Green, Color::Yellow, Color::Red, Color::Blue},CalibrationData::BlackWhiteCenter, {0.4f, 0.0f, 0.4f}}, // Rly右エッジで次の色地点まで
    {29,  {40.0f, 40.0f,  40.0f,   0.0f}, 0,  40, RunnerEdge::LeftEdge,  {Color::Green, Color::Yellow, Color::Red, Color::Blue},CalibrationData::BlackWhiteCenter, {0.4f, 0.0f, 0.4f}}, // Rly左エッジで次の色地点まで
...
const MoveScene moveScenes[] =
{
    ...
    { 3, Direction::front, {40.0f,  40.0f,  40.0f, 70.0f}, 70, {Color::None}, {5.0f, 0.0f, 0.0f}}, // Rly基準点中央まで
    ...
    { 9, Direction::front, {70.0f,  80.0f,  20.0f, 300.0f}, 300, {Color::None}, {3.0f, 0.0f, 0.0f}}, // Rlyゲートを通過
    ...
    {19, Direction::back,  {40.0f, 40.0f,   30.0f,  50.0f},50, {Color::None}, {3.0f, 0.0f, 0.0f}}, // ボトルデリバリー用バック
    {20, Direction::front, {40.0f, 40.0f,  30.0f, 60.0f},60, {Color::None}, {3.0f, 0.0f, 0.0f}}, // 代替処理用move
    {21, Direction::front, {30.0f, 80.0f,  30.0f, 1250.0f},1250, {Color::None}, {3.0f, 0.0f, 0.0f}}, // 実験用move
    {22, Direction::front, {40.0f,  40.0f,  30.0f,  20.0f},  20, {Color::None}, {3.0f, 0.0f, 0.0f}}, // ボトルデリバリー検知失敗時復帰用
    {23, Direction::back,  {40.0f, 40.0f,   30.0f,  30.0f}, 30, {Color::None}, {3.0f, 0.0f, 0.0f}}, // ボトルデリバリー検知失敗時用バック
