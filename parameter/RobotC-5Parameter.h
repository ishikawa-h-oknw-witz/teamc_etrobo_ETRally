...
const LineTraceScene lineTraceScenes[] =
{
    ...
    {26,  950, 100, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.3f, 0.0f, 0.4f}}, // Dlv帰還青まで
    {27,  230,  30, RunnerEdge::RightEdge, {Color::None}, CalibrationData::BlackWhiteCenter, {0.3f, 0.0f, 0.4f}}, // Dlv青半分まで

    {28,    0,  40, RunnerEdge::RightEdge, {Color::Green, Color::Yellow, Color::Red, Color::Blue},CalibrationData::BlackWhiteCenter, {0.4f, 0.0f, 0.4f}}, // Rly右エッジで次の色地点まで

    {29,    0,  40, RunnerEdge::LeftEdge,  {Color::Green, Color::Yellow, Color::Red, Color::Blue},CalibrationData::BlackWhiteCenter, {0.4f, 0.0f, 0.4f}}, // Rly左エッジで次の色地点まで
};
...
const MoveScene moveScenes[] =
{
    ...
    { 3, Direction::front, {30.0f,  40.0f,  30.0f,  70.0f},  70, {Color::None}, {1.0f, 0.0f, 0.0f}}, // Rly基準点中央まで
    { 4, Direction::front, {50.0f,  70.0f,  30.0f, 250.0f}, 250, {Color::None}, {1.0f, 0.0f, 0.0f}}, // Rlyゲート前1
    { 5, Direction::front, {50.0f, 100.0f,  30.0f, 500.0f}, 500, {Color::None}, {1.0f, 0.0f, 0.0f}}, // Rlyゲート前2
    { 6, Direction::front, {50.0f, 100.0f,  30.0f, 750.0f}, 750, {Color::None}, {1.0f, 0.0f, 0.0f}}, // Rlyゲート前3
    { 7, Direction::front, {50.0f, 100.0f,  30.0f,1000.0f},1000, {Color::None}, {1.0f, 0.0f, 0.0f}}, // Rlyゲート前4
    { 8, Direction::front, {50.0f, 100.0f,  30.0f,1250.0f},1250, {Color::None}, {1.0f, 0.0f, 0.0f}}, // Rlyゲート前5
    { 9, Direction::front, {30.0f, 100.0f,  30.0f, 300.0f}, 300, {Color::None}, {1.0f, 0.0f, 0.0f}}, // Rlyゲートを通過
    {10, Direction::front, {60.0f,  60.0f,  60.0f,   0.0f},   0, {Color::Green, Color::Yellow, Color::Red, Color::Blue},{1.0f, 0.0f, 0.0f}}, //基準点帰還
    {11, Direction::front, {30.0f,  50.0f,  30.0f, 100.0f}, 100, {Color::None}, {1.0f, 0.0f, 0.0f}}, // Rly目標外の基準点を通過
    {12, Direction::back,  {30.0f,  70.0f,  30.0f, 300.0f}, 300, {Color::None}, {1.0f, 0.0f, 0.0f}}, // Rlyゲートから後退して帰還
