...
const MoveScene moveScenes[] =
{
    ...
    { 1, Direction::back,  {30.0f, 60.0f,  30.0f,  130.0f}, 130, {Color::None}, {2.0f, 0.0f, 0.0f}}, // Dlv線まで帰還
    ...
    { 9, Direction::front, {70.0f,  80.0f,  25.0f, 300.0f}, 300, {Color::None}, {3.0f, 0.0f, 0.0f}}, // Rlyゲートを通過
