...
const MoveScene moveScenes[] =
{
    ...
    {14, Direction::front, {70.0f,  70.0f,  30.0f, 240.0f}, 240, {Color::None}, {3.0f, 0.0f, 0.0f}}, // 帰還1
    ...
    {32, Direction::front, {70.0f, 100.0f, 20.0f, 440.0f}, 440, {Color::None}, {3.0f, 0.0f, 0.0f}}, //Dlvボトル運び
